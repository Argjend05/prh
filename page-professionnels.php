...
<div class="pro-page">
    ...
    <section class="pro-hero">
        ...
        <!-- Image bannière -->
        <div class="pro-hero-img" aria-hidden="true">
            <picture>
                <source srcset="<?php echo esc_url( get_stylesheet_directory_uri() . '/assets/img/banniere-pro.avif' ); ?>" type="image/avif">
                <img src="<?php echo esc_url( get_stylesheet_directory_uri() . '/assets/img/banniere-pro.avif' ); ?>"
