...
/* =======================================================
   CHAMPS ACF — JSON stockés dans le thème enfant
   ======================================================= */
...
// ── ENREGISTREMENT DIRECT SUR acf/init ────────────────
...
function prh68_acf_register_groups()
{
    ...
    acf_add_local_field_group([
        ...
        'fields' => [
            ...
            [
                'key' => 'field_prh68_mission_subtitle',
                'label' => 'Sous-titre',
                'name' => 'prh68_mission_subtitle',
                'type' => 'textarea',
                'rows' => 2,
                'default_value' => "Partir des besoins concrets du terrain – Enfants, Parents, Professionnels – pour éclairer et faire évoluer les pratiques au regard des réalités du quotidien"
            ],
    ...
    acf_add_local_field_group([
        'key' => 'group_prh68_ml_hebergement',
        'title' => 'Hébergement',
        'menu_order' => 21,
        'position' => 'normal',
        'location' => $loc_ml,
    ...
    acf_add_local_field_group([
        ...
        'fields' => [
            ...
            [
                'key' => 'field_prh68_ml_pi_text1',
                'label' => 'Texte propriété',
                'name' => 'prh68_ml_pi_text1',
                'type' => 'textarea',
                'rows' => 3,
                'default_value' => "L'ensemble des contenus présents sur ce site (textes, images, graphismes, logos, vidéos, etc.) est la propriété exclusive de l'association Marguerite Sinclair."
            ],
            [
                'key' => 'field_prh68_ml_pi_text2',
                'label' => 'Texte Canva',
                'name' => 'prh68_ml_pi_text2',
                'type' => 'textarea',
                'rows' => 2,
                'default_value' => "Les éléments Canva utilisés sur ce site sont exploités sous licences conformément aux conditions d'utilisation de la plateforme Canva."
            ],
            [
                'key' => 'field_prh68_ml_pi_warning',
                'label' => 'Avertissement',
                'name' => 'prh68_ml_pi_warning',
                'type' => 'text',
                'default_value' => "Toute reproduction est interdite sans autorisation préalable écrite de l'association."
            ],
        ],
    ]);

    acf_add_local_field_group([
        'key' => 'group_prh68_ml_resp',
        'title' => 'Responsabilité & Cookies',
        'menu_order' => 23,
        'position' => 'normal',
        'location' => $loc_ml,
        'fields' => [
            ...
            [
                'key' => 'field_prh68_ml_resp_text',
                'label' => 'Responsabilité — Texte',
                'name' => 'prh68_ml_resp_text',
                'type' => 'textarea',
                'rows' => 3,
                'default_value' => "L'association s'efforce de fournir des informations précises et à jour, mais décline toute responsabilité pour d'éventuelles inexactitudes ou omissions présentes sur le site."
            ],
            ['key' => 'field_prh68_ml_cookies_title', 'label' => 'Cookies — Titre', 'name' => 'prh68_ml_cookies_title', 'type' => 'text', 'default_value' => 'Cookies'],
            [
                'key' => 'field_prh68_ml_cookies_text',
                'label' => 'Cookies — Texte',
                'name' => 'prh68_ml_cookies_text',
                'type' => 'textarea',
                'rows' => 3,
                'default_value' => "Le site ne collecte ni n'utilise de cookies. Aucune donnée de navigation n'est enregistrée ou transmise à des tiers."
            ],
        ],
    ]);

    acf_add_local_field_group([
        'key' => 'group_prh68_ml_droit',
        ...
        'fields' => [
            ...
            [
                'key' => 'field_prh68_ml_droit_text',
                'label' => 'Texte droit',
                'name' => 'prh68_ml_droit_text',
                'type' => 'textarea',
                'rows' => 3,
                'default_value' => "Le présent site et les présentes mentions légales sont soumis au droit français. En cas de litige, et à défaut de résolution amiable, la compétence exclusive est attribuée aux tribunaux français."
            ],
            ['key' => 'field_prh68_ml_update_date', 'label' => 'Date de mise à jour', 'name' => 'prh68_ml_update_date', 'type' => 'text', 'default_value' => 'Juin 2025'],
        ],
    ]);

    /* ── GROUPES PAGE ACCUEIL ───────────────────────────── */
    $loc_acc = [[['param' => 'page_template', 'operator' => '==', 'value' => 'page-accueil.php']]];

    /* ANNONCE & HERO */
    acf_add_local_field_group([
        'key' => 'group_prh68_acc_hero',
        'title' => 'Annonce & Hero',
        'menu_order' => 10,
        'position' => 'normal',
        'location' => $loc_acc,
        'fields' => [
            ...
            [
                'key' => 'field_prh68_acc_def_text',
                'label' => 'Bulle "inclusion" — Définition',
                'name' => 'prh68_acc_def_text',
                'type' => 'textarea',
                'rows' => 3,
                'default_value' => 'L\'inclusion désigne l\'accueil de tous les enfants, quels que soient leurs besoins, au sein des structures de droit commun, avec les adaptations nécessaires pour garantir leur participation, leur bien-être et leur développement.'
            ],
            [
                'key' => 'field_prh68_acc_def_note',
                'label' => 'Bulle "inclusion" — Note',
                'name' => 'prh68_acc_def_note',
                'type' => 'text',
                'default_value' => 'Cette définition est issue d\'une réflexion partagée et en lien avec les réalités du terrain.'
            ],
        ],
    ]);
    ...
    /* QUI SOMMES-NOUS */
    acf_add_local_field_group([
        'key' => 'group_prh68_acc_presentation',
    ...
    /* PROFESSIONNELS */
    acf_add_local_field_group([
        'key' => 'group_prh68_acc_pro',
        'title' => 'Section Professionnels',
        'menu_order' => 14,
        'position' => 'normal',
        'location' => $loc_acc,
        'fields' => [
    ...
    /* SERVICES — ACCORDÉONS */
    acf_add_local_field_group([
        'key' => 'group_prh68_acc_services',
        'title' => 'Services — Accordéons',
        'menu_order' => 15,
        'position' => 'normal',
        'location' => $loc_acc,
        'fields' => [
            ...
            [
                'key' => 'field_prh68_acc_srv4_items',
                'label' => 'Accordéon 4 — Points (1 par ligne)',
                'name' => 'prh68_acc_srv4_items',
                'type' => 'textarea',
                'rows' => 3,
                'default_value' => "S'approprier l'usage de matériel et d'outils d'adaptation à travers des actions de sensibilisation en lieu d'accueil.\nConsultez et emprunter les ressources disponibles."
            ],
            ['key' => 'field_prh68_acc_srv4_btn', 'label' => 'Accordéon 4 — Bouton texte', 'name' => 'prh68_acc_srv4_btn', 'type' => 'text', 'default_value' => 'Emprunter des ressources'],
        ],
    ]);

    /* ── GROUPES PAGE PROFESSIONNELS ───────────────────── */
    $loc_pro = [[['param' => 'page_template', 'operator' => '==', 'value' => 'page-professionnels.php']]];

    /* HERO */
    acf_add_local_field_group([
        'key' => 'group_prh68_pro_hero',
        'title' => 'Hero – Page Professionnels',
        'menu_order' => 30,
        'position' => 'normal',
        'location' => $loc_pro,
        'fields' => [
    ...
    /* CTA */
    acf_add_local_field_group([
        'key' => 'group_prh68_pro_cta',
        'title' => 'CTA – Page Professionnels',
        'menu_order' => 33,
        'position' => 'normal',
        'location' => $loc_pro,
        'fields' => [
...
function prh68_enqueue_styles()
{
    ...
    wp_enqueue_style('local-fonts', get_stylesheet_directory_uri() . '/css/fonts.css', ['parent-style'], wp_get_theme()->get('Version'));

    /* Script header (burger mobile) — chargé sur toutes les pages */
    wp_enqueue_script('header-script', get_stylesheet_directory_uri() . '/js/header.js', [], wp_get_theme()->get('Version'), true);

    /* Script commun (accordéons, helpers...) — chargé sur toutes les pages */
    wp_enqueue_script('common-script', get_stylesheet_directory_uri() . '/js/common.js', [], wp_get_theme()->get('Version'), true);

    if (is_page_template('page-accueil.php')) {
        wp_enqueue_style('accueil-style', get_stylesheet_directory_uri() . '/css/style-accueil.css', ['child-style'], wp_get_theme()->get('Version'));
        wp_enqueue_script('accueil-script', get_stylesheet_directory_uri() . '/js/accueil.js', [], wp_get_theme()->get('Version'), true);
    }

    if (is_page_template('page-mentions-legales.php')) {
        wp_enqueue_style('mentions-style', get_stylesheet_directory_uri() . '/css/style-mentions-legales.css', ['child-style'], wp_get_theme()->get('Version'));
    }

    if (is_page_template('page-professionnels.php')) {
        wp_enqueue_style('pro-style', get_stylesheet_directory_uri() . '/css/style-professionnels.css', ['child-style'], wp_get_theme()->get('Version'));
        wp_enqueue_script('pro-script', get_stylesheet_directory_uri() . '/js/professionnels.js', [], wp_get_theme()->get('Version'), true);
    }
}
