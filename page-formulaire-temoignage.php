                    ...
                    <fieldset class="ftem-fieldset">
                        ...
                        <div class="ftem-cond" data-show-if-types="video video_audio">
                            ...
                            <p class="ftem-cond-note">
                                ...
                                <span>Votre vidéo n'a pas de lien&nbsp;? <a href="<?php echo esc_url( get_permalink( get_page_by_path( 'formulaire-contact' ) ) ?: home_url( '/' ) ); ?>">Contactez l'équipe du PRH68</a> : nous la mettrons en ligne avec vous.</span>
                            </p>
                        </div>
                    </fieldset>
